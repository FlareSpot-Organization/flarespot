...
const SingleProduct = () => {
  ...
  // Handle property selection (only for products with properties)
  const handlePropertySelect = (
    ...
    if (propertyName.toLowerCase() === "color" && value.image) {
  ...
  const handleAddToCart = () => {
    if (hasSelectableProps && !activeSku) {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="bg-gray-200 w-full max-w-[1600px] mx-auto px-4 py-6 md:px-5 md:py-10">
          <div className="grid bg-white rounded-md p-4 md:p-5 grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="order-2 md:order-2 px-0 md:px-8">
              <h1 className="text-lg">{singleProduct?.result?.item?.title}</h1>
              ...
              <div className="relative">
                <div className="flex items-center">
                  ...
                  {((hasSelectableProps && activeSku?.promotionPrice) ||
                    (!hasSelectableProps && defaultSku?.promotionPrice)) && (
              ...
              <div className="mt-5">
                  ...
                  {(hasSelectableProps ? activeSku : defaultSku) && (
                    <div
                      className={`flex items-center space-x-2 ${
                        maxQuantity < 10 ? "text-orange-500" : "text-green-500"
                      }`}>
                      {maxQuantity < 10 ? (
                ...
                <div className="mt-4 flex gap-4 flex-col sm:flex-row">
                  <Button
                    disabled={inCart || (hasSelectableProps && !activeSku)}
                    size="lg"
                  ...
                  <Button
                    disabled={hasSelectableProps && !activeSku}
