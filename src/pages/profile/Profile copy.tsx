...
const Profile = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
          ...
          <div className="lg:col-span-1">
            <Card className="dark:bg-gray-900 border-0 shadow-md overflow-hidden rounded-xl">
              ...
              <CardContent className="pt-4">
                <Button
                  variant="outline"
                  className="w-full mb-4 border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
                  onClick={handleLogout}>
                  <LogOut className="w-4 h-4 mr-2 text-indigo-500 dark:text-indigo-400" />
                  Sign Out
                </Button>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {profileMenuItems.map((item, index) => (
                    <Card
                      key={index}
                      className="cursor-pointer hover:shadow-md transition-all border border-gray-100 dark:border-gray-800 dark:bg-gray-800/30 overflow-hidden"
                      onClick={() => handleNavigation(item.path)}>
                      <CardContent className="p-4 flex items-center">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/40 dark:to-purple-900/40 flex items-center justify-center mr-4">
