  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 relative rounded-lg overflow-hidden">
          ...
          <div
            ...
            <div className="z-10 relative mb-6 text-white">
              ...
              <button className="bg-black text-white px-6 py-3 rounded mt-4 hover:bg-gray-700 transition-colors">
                Shop Now
              </button>
            </div>
                ...
                {fashionItems.map((item) => (
                  <div
                    ...
                    <div className="flex justify-center">
                      <button className="bg-black text-[10px] text-white px-4 py-2 rounded mt-2 hover:bg-gray-700 transition-colors">
                        Visit Shop
                      </button>
                    </div>
                  </div>
        ...
        {/* Categories Slider */}
        <div className="relative grid grid-cols-2  gap-2 bg-gray-100 p-4 rounded-lg shadow-lg">
          {categories.map((category, index) => (
            <div
              key={index}
              className="flex flex-col items-center gap-4 bg-white p-4 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-xl">
              <div className="flex-1">
                <h3 className="font-semibold text-[11px]">{category.title}</h3>
              </div>
              <img
                src={category.image}
                alt={category.title}
